...
function api_photo_get($request)
{
    ...
    $photo_data = get_photo_data($post);
    $photo_data['acessos'] = (int) $photo_data['acessos'] + 1;
    update_post_meta($post_id, 'acessos', $photo_data['acessos']);
